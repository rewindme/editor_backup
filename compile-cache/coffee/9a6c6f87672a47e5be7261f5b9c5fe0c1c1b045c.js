(function() {
  var CompositeDisposable, DefaultSuggestionTypeIconHTML, IconTemplate, ItemTemplate, ListTemplate, SnippetEnd, SnippetParser, SnippetStart, SnippetStartAndEnd, SuggestionListElement, isString,
  ...
  SuggestionListElement = (function(_super) {
    ...
    SuggestionListElement.prototype.scrollSelectedItemIntoView = function() {
      ...
      if (selectedItemTop < scrollTop) {
        return this.selectedLi.scrollIntoView(true);
      }
    ...
    SuggestionListElement.prototype.renderItem = function(_arg, index) {
      ...
      sanitizedType = isString(type) ? type : '';
